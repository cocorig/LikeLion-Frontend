...
const Card = (props) => {
  console.log(props); // props로 className,value를 받는다. 
  console.log(props.children)// 자식 컴포넌트를 props로 받는다.
...
// </Card>)
  return (
    <>
      <Card className="setting" value="챌린지 설정"> 
        {/* Card컴포넌트에 <SettingCard/>를 자식컴포넌트로 넣어준다 */}
        {/* 결과적으로 Card컴포넌트와 SettingCard컴포넌트를 합성하여 사용한것 */}
        <SettingCard/>
      </Card>
